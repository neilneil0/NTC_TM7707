...
// jcn device no.
#define MY_DEVICE_ID       0x0007       // 0x0001: SmartRF with LCD; 0x0002: SmartRF; 0x0003:keyfob; 0x2541: 2541 iBeacon board
#define ALL_DEVICE_ID      0xffff       // for all devices in the network
#define TARGET_DEVICE_ID   0x0001
