...
/*
// JCN Service UUID: 0xFFE0
CONST uint8 JCNServUUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(JCN_SERV_UUID), HI_UINT16(JCN_SERV_UUID)
};
*/

/*
// JCN Characteristic 1 UUID: 0xFFE1
CONST uint8 JCNchar1UUID[ATT_BT_UUID_SIZE] =
{ 
  LO_UINT16(JCN_CHAR1_UUID), HI_UINT16(JCN_CHAR1_UUID)
};
*/
...
/*
// JCN Service attribute
static CONST gattAttrType_t JCNService = { ATT_BT_UUID_SIZE, JCNServUUID };

// JCN Characteristic 1 Properties
static uint8 JCNChar1Props = GATT_PROP_READ | GATT_PROP_WRITE;

// JCN Characteristic 1 Value
static uint8 JCNChar1 = 0;

// JCN Characteristic 1 User Description
static uint8 JCNChar1UserDesp[20] = "JCNCharacteristic 1\0";
*/
...
static gattAttribute_t simpleProfileAttrTbl[SERVAPP_NUM_ATTR_SUPPORTED] = 
{
  ...
  { 
    ...
    0,                                        /* handle */
    (uint8 *)&simpleProfileService            /* pValue */      //0xFFF0
  },
    ...
    { 
      ...
      { 
        ...
        GATT_PERMIT_READ, 
        0, 
        simpleProfileChar1UserDesp      //"Characteristic 1\0"
      },      
